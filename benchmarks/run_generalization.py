    ...
    *,
    ...
    for benchmark_name, (base_objective, bounds) in DEFAULT_BENCHMARKS.items():
        ...
        cases = [
            ...
            ("short_budget", max(100, budget // 10), False),
        ]
        ...
        for case_name, case_budget, noisy in cases:
            for optimizer_name, optimizer_type in OPTIMIZERS.items():
                ...
                for seed in range(seeds):
                    ...
                    if noisy:
                        # Separate but deterministic measurement process for each run.
                    ...
                    # Report the true, noise-free objective at the returned solution.
