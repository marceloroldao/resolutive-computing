    ...
    for name, (objective, bounds) in FUNCTIONS.items():
        for seed in range(seeds):
            ...
            rows.append({
                ...
                "incremental_core": inc.diagnostics.get("core"),
                "ruggedness": inc.diagnostics.get("ruggedness"),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="results/hybrid_session_compare.csv")
